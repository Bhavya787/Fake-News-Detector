#!/usr/bin/env python3
# main.py - Flask Web Application for Fake News Detection
# This file contains the Flask web application that uses the FakeNewsDetector class

import sys
import os

# Ensure the src directory is in the Python path for absolute imports
# This is crucial for running the app directly and for imports to work correctly on Windows
...
# This will load the model when the Flask app starts
